...
- Modules
  ...
  - [commons.bit32ops](/commons_bit32ops.md): Lua-5.1/Luajit-2 compatible 32-bit operations, a wrapper on [BitOp](https://bitop.luajit.org/index.html) (if `bit` module exists) or [AlberTajuelo/bitop-lua](https://github.com/AlberTajuelo/bitop-lua) (otherwise).
