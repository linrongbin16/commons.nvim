...
describe("commons.num", function()
  ...
  describe("[test]", function()
    ...
    it("clamp", function()
      assert_eq(num.clamp(5, 1, 3), 3)
      assert_eq(num.clamp(2, 1, 13), 2)
      assert_eq(num.clamp(77), 77)
      assert_eq(num.clamp(77, nil, 29), 29)
    end)
    it("clamp left", function()
      assert_eq(num.clamp(1, 1, 2), 1)
      assert_eq(num.clamp(1, 2, 3), 2)
      assert_eq(num.clamp(1, 3, 4), 3)
      assert_eq(num.clamp(2, 3, 4), 3)
      assert_eq(num.clamp(3, 3, 4), 3)
      assert_eq(num.clamp(4, 3, 4), 4)
      assert_eq(num.clamp(-10, nil), -10)
    end)
    it("clamp right", function()
      assert_eq(num.clamp(1, 1, 5), 1)
      assert_eq(num.clamp(3, 2, 6), 3)
      assert_eq(num.clamp(5, 3, 7), 5)
      assert_eq(num.clamp(9, 3, 8), 8)
      assert_eq(num.clamp(10, 3, 9), 9)
      assert_eq(num.clamp(15, 3, 10), 10)
      assert_eq(num.clamp(15, 3), 15)
    end)
    it("max", function()
