...
describe("commons.numbers", function()
  ...
  describe("[test]", function()
    ...
    it("eq/ne floats approximate", function()
      assert_true(numbers.eq(1.123, 1.124, 0.1, 0.1))
      assert_true(numbers.eq(1.123, 1.124, 0.01, 0.01))
      assert_true(numbers.eq(1.123, 1.124, 0.001, 0.001))
      assert_false(numbers.eq(1.123, 1.124, 0.0001, 0.0001))
      assert_false(numbers.eq(1.123, 1.124))

      assert_false(numbers.ne(1.123, 1.124, 0.1, 0.1))
      assert_false(numbers.ne(1.123, 1.124, 0.01, 0.01))
      assert_false(numbers.ne(1.123, 1.124, 0.001, 0.001))
      assert_true(numbers.ne(1.123, 1.124, 0.0001, 0.0001))
      assert_true(numbers.ne(1.123, 1.124))
    end)
    it("lt/le", function()
    ...
    it("lt/le floats approximate", function()
      assert_false(numbers.lt(1.123, 1.124, 0.1, 0.1))
      assert_false(numbers.lt(1.123, 1.124, 0.01, 0.01))
      assert_false(numbers.lt(1.123, 1.124, 0.001))
      assert_true(numbers.lt(1.123, 1.124, 0.0001))
      assert_true(numbers.lt(1.123, 1.124))

      assert_true(numbers.le(1.125, 1.124, 0.1))
      assert_true(numbers.le(1.125, 1.124, 0.01))
      assert_true(numbers.le(1.125, 1.124, 0.001))
      assert_false(numbers.le(1.125, 1.124, 0.0001))
      assert_false(numbers.le(1.125, 1.124))
    end)
    it("gt/ge", function()
    ...
    it("gt/ge floats approximate", function()
      assert_false(numbers.gt(2.17, 2.18, 0.1))
      assert_false(numbers.gt(2.17, 2.18, 0.01, 0.01))
      assert_false(numbers.gt(2.17, 2.18))
      assert_true(numbers.gt(2.19, 2.18))

      assert_true(numbers.ge(2.17, 2.18, 0.1))
      assert_true(numbers.ge(2.17, 2.18, 0.01, 0.01))
      assert_false(numbers.ge(2.17, 2.18))
      assert_true(numbers.ge(2.19, 2.18))
    end)
    it("bound", function()
