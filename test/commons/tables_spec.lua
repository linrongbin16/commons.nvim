...
describe("commons.tables", function()
  ...
  local tbls = require("commons.tables")
  ...
  describe("strings", function()
    ...
    it("tbl_get", function()
      ...
      assert_eq(tbls.tbl_get({ c = { 1, 2, 3 } }, "c", 2), 2)
      assert_eq(tbls.tbl_get({ c = { 1, 2, 3 } }, "c", 4), nil)
      assert_eq(tbls.tbl_get(nil, "c"), nil)
      assert_eq(tbls.tbl_get({}, "c"), nil)
    end)
    it("list", function()
