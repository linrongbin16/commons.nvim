...
describe("commons.logger", function()
  ...
  local LogLevelNames = require("commons.logger").LogLevelNames
  ...
  describe("[log]", function()
    ...
    it("ensure", function()
      ...
      logger.ensure(true, "ensure with 3 parameters: %s, %d, %f", "a", 1, 3.12)
      assert_true(true)
      local ok1, err1 = pcall(logger.ensure, false, "ensure without parameters")
      ...
      assert_false(ok2)
      local ok3, err3 =
        pcall(logger.ensure, false, "ensure with 2 parameters: %s, %d", "a", 1)
    ...
    it("throw", function()
      ...
      local ok2, msg2 = pcall(logger.throw, "throw with 1 params: %s", "a")
      assert_false(ok2)
  ...
  describe("[echo]", function()
    it("info", function()
      ...
      logger.echo(LogLevels.INFO, "echo with 2 parameters: %s, %d", "a", 1)
      logger.echo(
        LogLevels.INFO,
    ...
    it("debug", function()
      ...
      logger.echo(LogLevels.DEBUG, "echo with 2 parameters: %s, %d", "a", 1)
      logger.echo(
        LogLevels.DEBUG,
        "echo with 3 parameters: %s, %d, %f",
        "a",
    ...
    it("warn", function()
      ...
      logger.echo(LogLevels.WARN, "echo with 2 parameters: %s, %d", "a", 1)
      logger.echo(
        LogLevels.WARN,
        "echo with 3 parameters: %s, %d, %f",
        "a",
    ...
    it("err", function()
      ...
      logger.echo(LogLevels.ERROR, "echo with 2 parameters: %s, %d", "a", 1)
      logger.echo(
        LogLevels.ERROR,
        "echo with 3 parameters: %s, %d, %f",
        "a",
