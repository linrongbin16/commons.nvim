...
describe("commons.numbers", function()
  ...
  describe("[test]", function()
    ...
    it("incremental_id", function()
      local id1 = numbers.incremental_id()
      assert_true(id1 >= 1)
      local id2 = numbers.incremental_id()
      assert_eq(id2, id1 + 1)
      local id3 = numbers.incremental_id()
      assert_eq(id3, id2 + 1)
      assert_true(numbers.incremental_id() == numbers.incremental_id() - 1)
    end)
  end)
end)
